---
name: helix-vpn
description: Use this skill when generating Open Design artifacts that should follow Helix VPN.
user-invocable: true
---
...
- Creating product-like prototypes that should follow Helix VPN.
